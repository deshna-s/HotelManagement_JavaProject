...
JLabel background;
ImageIcon img=new ImageIcon("hotel1.jpg");
background = new JLabel("",img,JLabel.CENTER);
 background.setPreferredSize(new Dimension(600, 350));
